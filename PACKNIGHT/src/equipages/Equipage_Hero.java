...
public class Equipage_Hero extends Equipage{
		...
		public void init() throws SlickException{
			...
			Joueur FM_4 = new Joueur(this.g.SPRITE_GHOST_2,this.g, GHOST_4,"fm_intercepteur.xml");
	   ...
	   public static void main(String[] argv) {
		      try {
		         Menu.container = new AppGameContainer(new Menu(new Equipage_Hero()));
