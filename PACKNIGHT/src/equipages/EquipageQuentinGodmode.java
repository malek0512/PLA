...
public class EquipageQuentinGodmode extends equipages.Equipage {
...
//		this.joueurFleche =  PACMAN_1;
	   ...
	   public static void main(String[] argv) {
		      try {
		         Menu.container = new AppGameContainer(new Menu(new EquipageQuentinGodmode()));
