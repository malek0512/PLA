...
public class Equipage_Facile extends Equipage{
		...
		public void init() throws SlickException{
			...
			Joueur FM_2 = new Joueur(this.g.SPRITE_GHOST_2,this.g, GHOST_2,"fm_aleatoire.xml");
			Joueur FM_3 = new Joueur(this.g.SPRITE_GHOST_2,this.g, GHOST_3,"fm_aleatoire.xml");
			Joueur FM_4 = new Joueur(this.g.SPRITE_GHOST_2,this.g, GHOST_4,"fm_aleatoire_aveugle.xml");
	   ...
	   public static void main(String[] argv) {
		      try {
		         Menu.container = new AppGameContainer(new Menu(new Equipage_Facile()));
