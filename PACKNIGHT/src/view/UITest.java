...
public class UITest extends InputAdapter implements ApplicationListener {
	...
	public void create () {
		...
		scrollPane2.setupFadeScrollBars(0, 0);
//		scrollPane2.setWidth(1);
//		scrollPane2.setHeight(1);
		scrollPane2.setScrollY(25);
...
//		window.add(splitPane).fill().expand().colspan(4).maxHeight(200);
		window.add(scrollPane2).fill().expand().colspan(2).maxHeight(30);
		window.row();
