...
public class Equipage_test_princesse extends Equipage {
	...
	Ghost GHOST_1 = new Ghost("1", 1, 1, Direction.droite,new CoordonneesFloat(14, 14));
	Ghost GHOST_2 = new Ghost("2", 1, 1, Direction.droite,new CoordonneesFloat(14, 14));
	Ghost GHOST_3 = new Ghost("3", 1, 1, Direction.droite,new CoordonneesFloat(14, 14));
	Ghost GHOST_4 = new Ghost("4", 1, 1, Direction.droite,new CoordonneesFloat(14, 14));
