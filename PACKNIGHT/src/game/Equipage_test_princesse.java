...
public class Equipage_test_princesse extends Equipage {
	...
	PacKnight PACMAN_1= new PacKnight("J1",17,17,Direction.droite,new CoordonneesFloat(1, 1), false);
...
//	PacKnight PACMAN_3 = new PacKnight("J3",5,10,Direction.droite,new CoordonneesFloat(1, 1), false);
	...
	Ghost GHOST_1 = new Ghost("1", 17, 1, Direction.droite,new CoordonneesFloat(5, 15));
	Ghost GHOST_2 = new Ghost("2", 17, 1, Direction.droite,new CoordonneesFloat(1, 1));
	Ghost GHOST_3 = new Ghost("3", 1, 17, Direction.droite,new CoordonneesFloat(1, 1));
	Ghost GHOST_4 = new Ghost("4", 1, 17, Direction.droite,new CoordonneesFloat(1, 1));
	...
	public void init() throws SlickException {
		Joueur PM_1 = new Joueur(this.g.SPRITE_PACMAN_1,this.g, PACMAN_1,"pa_fuit.xml");
...
//		Joueur PM_4 = new Joueur(this.g.SPRITE_PACMAN_4,this.g, PACMAN_4, "princesse.xml");
		...
		Joueur FM_3 = new Joueur(this.g.SPRITE_GHOST_3,this.g, GHOST_3,"fm_suiveur.xml");
